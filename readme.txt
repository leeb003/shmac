...
1. Upload the ZIP file (shmac.zip) through the 'Plugins > Add New > Upload' screen in your WordPress dashboard
...
== Upgrade Notice ==
= 1.1.4 =
* Insurance estimates modification, css unique form input class names
